...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<AudioPlugin_TestAudioProcessor::BlockType>& scsf) :
...
/**
*/
class AudioPlugin_TestAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    AudioPlugin_TestAudioProcessorEditor (AudioPlugin_TestAudioProcessor&);
    ~AudioPlugin_TestAudioProcessorEditor() override;
